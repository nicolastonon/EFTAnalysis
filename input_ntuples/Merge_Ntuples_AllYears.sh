...
if [ "$processMC" = true ]; then
    ...
    do
        ...
        #ZZTo4l (all prod modes)
        hadd -f $outDir/$dirname/ZZ4l.root $outDir/$dirname/merged_ZZTo4L*.root $outDir/$dirname/merged_GluGluToContinToZZTo*.root $outDir/$dirname/merged_GluGluHToZZTo4L*.root $outDir/$dirname/merged_VBF_HToZZTo4L*.root $outDir/$dirname/merged_VHToNonbb*.root
        ...
        #ZGToLLG_01J (sums ZGToLLG_01J+ZGToLLG_01J_LoosePtlPtg)
        hadd -f $outDir/$dirname/ZGToLLG_01J.root $outDir/$dirname/merged_ZGToLLG_01J*.root
